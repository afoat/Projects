namespace Foat.Collections.Generic.Tests
{
    ...
    public partial class BinarySearchTreeTests : IBinarySearchTreeTests<RedBlackTree<int>>
    {
        ...
        public override void Insert_ThirdNodeAtStart_IntoRootLeft()
        {
            ...
            Assert.AreEqual<int>(50, InstanceRootLeft.Root.Value);
            Assert.AreEqual<int>(25, InstanceRootLeft.Root.Left.Value);
            Assert.AreEqual<int>(13, InstanceRootLeft.Root.Left.Left.Value);

            Assert.IsNull(InstanceRootLeft.Root.Right);
            Assert.IsNull(InstanceRootLeft.Root.Left.Right);
            Assert.IsNull(InstanceRootLeft.Root.Left.Left.Left);
            Assert.IsNull(InstanceRootLeft.Root.Left.Left.Right);
        }
        ...
        public override void Insert_ThirdNodeInMiddle_IntoRootLeft()
        {
            ...
            Assert.AreEqual<int>(50, InstanceRootLeft.Root.Value);
            Assert.AreEqual<int>(25, InstanceRootLeft.Root.Left.Value);
            Assert.AreEqual<int>(32, InstanceRootLeft.Root.Left.Right.Value);

            Assert.IsNull(InstanceRootLeft.Root.Right);
            Assert.IsNull(InstanceRootLeft.Root.Left.Left);
            Assert.IsNull(InstanceRootLeft.Root.Left.Right.Left);
            Assert.IsNull(InstanceRootLeft.Root.Left.Right.Right);
        }
        ...
        public override void Insert_ThirdNodeAtEnd_IntoRootRight()
        {
            ...
            Assert.AreEqual<int>(50, InstanceRootRight.Root.Value);
            Assert.AreEqual<int>(75, InstanceRootRight.Root.Right.Value);
            Assert.AreEqual<int>(100, InstanceRootRight.Root.Right.Right.Value);

            Assert.IsNull(InstanceRootRight.Root.Left);
            Assert.IsNull(InstanceRootRight.Root.Right.Left);
            Assert.IsNull(InstanceRootRight.Root.Right.Right.Left);
            Assert.IsNull(InstanceRootRight.Root.Right.Right.Right);
        }
        ...
        public override void Insert_ThirdNodeInMiddle_IntoRootRight()
        {
            ...
            Assert.AreEqual<int>(50, InstanceRootRight.Root.Value);
            Assert.AreEqual<int>(75, InstanceRootRight.Root.Right.Value);
            Assert.AreEqual<int>(62, InstanceRootRight.Root.Right.Left.Value);

            Assert.IsNull(InstanceRootRight.Root.Left);
            Assert.IsNull(InstanceRootRight.Root.Right.Right);
            Assert.IsNull(InstanceRootRight.Root.Right.Left.Left);
            Assert.IsNull(InstanceRootRight.Root.Right.Left.Right);
        }
        ...
        {
            InstanceFourNodesRightRight.AssertValidTree();
