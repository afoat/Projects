namespace Foat.Puzzles.RubiksCube
{
    ...
    public struct Position
    {
        ...
        private static byte[] _LookupRotateTopCW;
        private static byte[] _LookupRotateTopCCW;
        private static byte[] _LookupRotateTopHalf;

        private static byte[] _LookupRotateBottomCW;
        private static byte[] _LookupRotateBottomCCW;
        private static byte[] _LookupRotateBottomHalf;

        private static byte[] _LookupRotateLeftCW;
        private static byte[] _LookupRotateLeftCCW;
        private static byte[] _LookupRotateLeftHalf;

        private static byte[] _LookupRotateRightCW;
        private static byte[] _LookupRotateRightCCW;
        private static byte[] _LookupRotateRightHalf;

        private static byte[] _LookupRotateFrontCW;
        private static byte[] _LookupRotateFrontCCW;
        private static byte[] _LookupRotateFrontHalf;

        private static byte[] _LookupRotateBackCW;
        private static byte[] _LookupRotateBackCCW;
        private static byte[] _LookupRotateBackHalf;
        ...
        static Position()
        {
            ...
            _LookupRotateBottomCW = new byte[] {
            ...
            _LookupRotateBottomCCW = new byte[] {
            ...
            _LookupRotateBottomHalf = new byte[] {
            ...
            _LookupRotateLeftHalf = new byte[] {
            ...
            _LookupRotateRightCCW = new byte[] {
            ...
            _LookupRotateRightHalf = new byte[] {
            ...
            _LookupRotateFrontCCW = new byte[] {
            ...
            _LookupRotateFrontHalf = new byte[] {
            ...
            _LookupRotateBackHalf = new byte[] {
