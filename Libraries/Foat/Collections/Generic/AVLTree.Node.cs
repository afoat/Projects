namespace Foat.Collections.Generic
{
    ...
    public sealed partial class AVLTree<T> where T : IComparable<T>
    {
        internal sealed class Node
        {
            /// <summary>
            /// Creates a new instance of a Foat.Collections.Generic.AVLNode
            /// </summary>
            ...
            private int GetChildNodeHeight(Node node)
            {
